  ...
  return (
    <>
      <ul className="navbar">
        ...
        <NavItem categoryName='Product Management'>
          <li className="sub_nav_item">
            <Link to='/admin/categories' className='nav_link'>Catagories</Link>
          </li>
          {/* <li className="sub_nav_item">
            <Link to='/sub-categories' className='nav_link'>Sub- Catagories</Link>
          </li> */}
          <li className="sub_nav_item">
            <Link to='/admin/product' className='nav_link'>Product</Link>
          </li>
          {/* <li className="sub_nav_item">
